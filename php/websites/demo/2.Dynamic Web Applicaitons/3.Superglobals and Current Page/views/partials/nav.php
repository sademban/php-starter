        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" class="<?=  urlIs('/') ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white': 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white'?>">Home</a>
              <a href="/about.php" class="<?=  $_SERVER['REQUEST_URI'] === '/about.php'? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white': 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white'?>">About</a>
              <a href="/contact.php" class="<?= $_SERVER['REQUEST_URI'] === '/contact.php'? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white': 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white'?>">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
